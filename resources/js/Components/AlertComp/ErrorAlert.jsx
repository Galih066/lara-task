...
const ErrorAlert = ({ title, description, duration = 5000, onClose }) => {
    ...
    return (
        <div
            className={`fixed top-4 right-4 max-w-md w-full transform transition-all duration-300 ease-in-out ${isLeaving ? 'opacity-0 translate-x-full' : 'opacity-100 translate-x-0'
                }`}
            role="alert"
            aria-live="assertive"
        >
