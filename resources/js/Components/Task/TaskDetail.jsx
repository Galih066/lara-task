        ...
        <>
            ...
            <div
                className={`fixed inset-0 bg-black transition-opacity duration-300 ease-in-out z-[60] ${
                    isVisible ? 'bg-opacity-25' : 'bg-opacity-0 pointer-events-none'
                }`}
                onClick={onClose}
            />
            ...
            {/* Panel */}
            <div
                className={`fixed inset-y-0 right-0 w-[800px] bg-white shadow-xl transform transition-all duration-300 ease-in-out z-[70] ${
